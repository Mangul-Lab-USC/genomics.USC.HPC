...
echo "/home/rcf-proj/sm3/akarlsbe/code/TRUST4/run-trust4 -b ${line}.bam -f /home/rcf-proj/sm3/akarlsbe/code/TRUST4/hg38_bcrtcr.fa --ref /home/rcf-proj/sm3/akarlsbe/code/TRUST4/human_IMGT+C.fa -o TRUST4.${line}/${line}." >>run.TRUST4.${line}.sh

echo "ls>done.txt" >> run.TRUST4.${line}.sh

sbatch --ntasks=4 --mem-per-cpu=16G --time=24:00:00 run.TRUST4.${line}.sh #-p scavenge
