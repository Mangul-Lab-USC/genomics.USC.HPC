...
echo "/home/rcf-proj/sm3/akarlsbe/anaconda2/bin/python /home/rcf-proj/sm3/akarlsbe/code/imrep/imrep.py --extendedOutput --hg38 --bam  --noOverlapStep --noCast ${line}.bam ${line}.cdr3" >>run.imrep.${line}.sh
