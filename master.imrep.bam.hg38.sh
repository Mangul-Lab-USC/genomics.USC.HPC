...
echo "/home/rcf-proj/sm3/akarlsbe/anaconda2/bin/python /u/home/s/serghei/project/code/seeing.beyond.target/tools/imrep/imrep.py --hg38 --bam  --noOverlapStep --noCast ${line}.bam ${line}.cdr3" >>run.imrep.${line}.sh
